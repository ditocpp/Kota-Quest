...
class ListDataAdapter3(private val data: ArrayList<Quest>): RecyclerView.Adapter<ListDataAdapter3.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ListViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context).inflate(R.layout.quest_item_posted, viewGroup, false)
    ...
    inner class ListViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        var qTitle: TextView? = itemView.findViewById(R.id.quest_item_posted_title)
        var qLocation: TextView? = itemView.findViewById(R.id.quest_item_posted_location)
        var qDescription: TextView? = itemView.findViewById(R.id.quest_item_posted_description)
        var qImage: ImageView? = itemView.findViewById(R.id.quest_item_posted_image)
        var btnR: Button? = itemView.findViewById(R.id.quest_item_posted_btnR)
        var btnL: Button? = itemView.findViewById(R.id.quest_item_posted_btnL)
    }
}
